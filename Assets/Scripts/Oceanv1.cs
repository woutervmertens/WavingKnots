...
/* -------------------------------------------------------------------------------
	...
	When the component is started it creates a conical Oceanv1 Mesh based on
	the ViewDistance and TileSize. The Oceanv1 mesh is added to the MeshFilter.
 
	An Oceanv1.WaveEmitter is an object which releases a sinus wave on the Oceanv1
	with a specific frequency, wavelength and amplitude.
 
	The Oceanv1 GameObject will always be centered on the FollowCamera. If the
	FollowCamera moves under the Oceanv1 height the Mesh normals are flipped to
	...
	Since the Oceanv1 GameObject remains centered, the Oceanv1 textures needs to be
	moved manually in the SetTextureOffset method to provide the illusion of movement.
 ------------------------------------------------------------------------------ */
[RequireComponent(typeof(MeshFilter))]
public class Oceanv1 : MonoBehaviour
{
    ...
    void Update()
    {
        // Keep the Oceanv1 centered on the FollowCamera
